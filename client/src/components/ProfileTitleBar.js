...
function ProfileTitleBar({userData, amountOfReviews, totalSumLikes, handleProfEditTog}) {
...
return (
  ...
  <h2> <img src={userData.profile_img} alt={unknownPerson} className="profile-pic"/>{userData.username}'s Profile</h2>
    ...
    <button onClick={handleProfEditTog}>edit profile</button> <Link to="/home"><button variant="contained">back home</button></Link>
    </div>
)
}
